...
public class ExpandableListActivity extends AppCompatActivity {
    ...
    int [] groupImages = {R.drawable.mercury,R.drawable.venus,R.drawable.earth,R.drawable.mars,R.drawable.jupiter,R.drawable.saturn,R.drawable.uranas,R.drawable.neptune,R.drawable.pluto,R.drawable.exoplanet};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data();
        ExpandableListAdapter adapter = new ExpandableListAdapter(this,groupData,childData,groupImages);
    ...
    private void data() {
        String[] headerString = getResources().getStringArray(R.array.planets_array);
        String[] childString = getResources().getStringArray(R.array.planets_array_subtitle);
